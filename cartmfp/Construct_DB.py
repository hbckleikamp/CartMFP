...
def construct_DB(
                 ...
                 filt_7gr=filt_7gr,
                 filt_LewisSenior=filt_LewisSenior,
                 filt_ratios=filt_ratios,
                 filt_NOPS=filt_NOPS,
                 filt_multimetal=filt_multimetal,
                 filt_halogens=filt_halogens,
                 Crats=Crats,
                 Crdbes=Crdbes,
    ...
    if need_batches:
        ...
        if filt_halogens or filt_multimetal:
            ...
            bm=np.vstack([np.hstack(p).astype(bitlim) for p in product(*barrs)]).T
