...
#test casmi
composition_file="C:/CartMFP/Timing_scripts/CartMFP/Cart_Output/H[320]C[120]N[80]O[80]P[16]S[16]_b40000max1600rdbe-5_116.0_comp.npy"
...
if not hasattr(sys,'ps1'): #checks if code is executed from command line
    ...
    parser.add_argument("-top_candidates",  default=20, required = False, help="number of best candidates returned (sorted by mass error)",type=int)  
